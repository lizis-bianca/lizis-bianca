...
<!-- text -->
<div id="text">
  <img src="./assets/images/Monstera_deliciosa.jpg" min-width="250px" max-width="250px" width="250px" align="right" style="border-radius:25%; margin-top: 25px; margin-bottom: 150px" alt="Costela-de-ad�o">
