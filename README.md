...
Durante minha jornada, iniciei atuando como <i name="user-content-i" style="color: #75F76A">programadora desktop</i>, trabalhando com a manutenção e desenvolvimento de funcionalidades para <b>PDV</b> e <b>ERP legado</b>, utilizando as linguagens de programação <i>C#, VB6 e VB.net</i> e <i>práticas ágeis de scrum</i>, onde adquiri entendimento sobre regras de negócios do varejo e regras fiscais.

Devido uma serie de novos processos e realocação, venho atuando na área de desenvolvimento web como <i name="user-content-i" style="color: #75F76A">desenvolvedora full stack</i>, trabalhando com soluções serveless em clean architecture sobre <b>emissão de documentos fiscais</b>.
